...
): boolean => !areDecimalsEqual(decimal, otherDecimal, precision) && decimal > otherDecimal
...
export { areDecimalsEqual, isDecimalHigher, isDecimalLower, isDecimalHigherOrEqual, isDecimalLowerOrEqual }
