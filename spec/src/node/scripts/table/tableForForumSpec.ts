...
describe("formatTableForForum", (): void => {
    it("formats a table to be posted on the Sagittal forum", (): void => {
        const table = [
            ["comma name", "prime limit", "2,3-free SoPFR", "cents", "vector", "quotient", "apotome slope", "N2D3P9"],
        ...
        let expected =
            "[table]" + NEWLINE +
            "[tr][th]comma name[/th][th]prime limit[/th][th]2,3-free SoPFR[/th][th]cents[/th][th]vector[/th][th]quotient[/th][th]apotome slope[/th][th]N2D3P9[/th][/tr]" + NEWLINE +
    ...
    it("supports a custom count of header rows", (): void => {
        ...
        let expected =
            ...
            "[tr][th]name[/th][th]limit[/th][th]SoPFR[/th][th]cents[/th][th]vector[/th][th]quotient[/th][th]slope[/th][th]N2D3P9[/th][/tr]" + NEWLINE +     // Note the second header row!
            "[tr][td]11M[/td][td]11[/td][td]11[/td][td]45.45[/td][td][0 0 1⟩[/td][td]33/32[/td][td]-4[/td][td]6.722[/td][/tr]" + NEWLINE +
            "[tr][td]25/49M[/td][td]7[/td][td]24[/td][td]33.4[/td][td][0 0⟩[/td][td]50/49[/td][td]-59.333[/td][td]26.466[/td][/tr]" + NEWLINE +
            "[/table]" + NEWLINE as Io
        expect(actual).toEqual(expected)
    ...
    it("supports colors per row", (): void => {
        ...
        let expected =
            ...
            "[tr][td][hilite=red]name[/hilite][/td][td][hilite=red]limit[/hilite][/td][td][hilite=red]SoPFR[/hilite][/td][td][hilite=red]cents[/hilite][/td][td][hilite=red]vector[/hilite][/td][td][hilite=red]quotient[/hilite][/td][td][hilite=red]slope[/hilite][/td][td][hilite=red]N2D3P9[/hilite][/td][/tr]" + NEWLINE +
    ...
    it("supports alignment", (): void => {
        ...
        let expected =
            ...
            "[tr][thr]name[/thr][th]limit[/th][thl]SoPFR[/thl][th]cents[/th][th]vector[/th][th]quotient[/th][th]slope[/th][th]N2D3P9[/th][/tr]" + NEWLINE +
