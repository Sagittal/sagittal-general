import { compute23FreeClass, Rational, ScaledVector, Two3FreeClass } from "../../../../../src"

describe("compute23FreeClass", (): void => {
    it("returns the 2,3-free, THEN super taken (n ≥ d) version of the pitch, branded", (): void => {
        const jiPitch = { vector: [4, 1, -2] } as ScaledVector<Rational> // 48/25
    ...
    it("trims the vector if necessary", (): void => {
        const jiPitch = { vector: [4, 1] } as ScaledVector<Rational> // 48/1
